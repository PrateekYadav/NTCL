...
public class Fpage extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page_f);
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (id) {
                            case R.id.home:
                                ...
                                Intent r = new Intent(Fpage.this, HomeActivity.class);
                                startActivity(r);
                                break;
                            case R.id.HR:
                                // set item as selected to persist highlight
                                ...
                                // close drawer when item is tapped
                                mDrawerLayout.closeDrawers();
                                Intent i = new Intent(Fpage.this, HRpage.class);
                                startActivity(i);
                                break;
                            case R.id.mark:
                                // set item as selected to persist highlight
                                ...
                                // close drawer when item is tapped
                                mDrawerLayout.closeDrawers();
                                Intent x = new Intent(Fpage.this, Mpage.class);
                                startActivity(x);
                                break;
                            case R.id.tech:
                                // set item as selected to persist highlight
                                ...
                                // close drawer when item is tapped
                                mDrawerLayout.closeDrawers();
                                Intent k = new Intent(Fpage.this, Tpage.class);
                                startActivity(k);
                                break;
                            case R.id.fin:
                                // set item as selected to persist highlight
                                ...
                                // close drawer when item is tapped
                                mDrawerLayout.closeDrawers();
                                Intent l = new Intent(Fpage.this, Fpage.class);
                                startActivity(l);
                                break;
                            case R.id.logout:
                                // set item as selected to persist highlight
                                ...
                                // close drawer when item is tapped
                                mDrawerLayout.closeDrawers();
                                Intent j = new Intent(Fpage.this, MainActivity.class);
                                startActivity(j);
